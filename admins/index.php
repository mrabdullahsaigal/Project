...
<div class="wrapper">
    ...
    <nav id="sidebar" class="bg-light">
        <ul class="list-unstyled components">
            <li class="active">
                <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle nav-link bg-dark">
                    <i class="fa fa-briefcase" aria-hidden="true"></i>
                    Categories
                </a>
                <ul class="collapse show list-unstyled bg-dark" id="homeSubmenu">
                    <?php getCats(); ?>
                </ul>
            </li>
            <li class="active">
