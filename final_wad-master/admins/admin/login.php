...
if(isset($_POST['login'])){
    ...
    $pass = $_POST['password'];
    $sel_user = "select * from admin where username='$email' AND password='$pass'";
...
<body class="text-center bg-primary">
    <form class="login_form" action="login.php" method="post">
        ...
        <input type="text" id="user_email" name="username"
               value="<?php echo @$_COOKIE['username']?>" class="form-control" placeholder="Email address" required autofocus>
               <br>
        <input type="password" id="user_pass" name="password"
               value="<?php echo @$_COOKIE['password']?>" class="form-control" placeholder="Password" required><br>
